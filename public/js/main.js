...
const getInfo = async (event)=>{
    ...
    if(cityVal === ''){
        city_name.innerText = "Please Enter a City before searching";
        dataHide.classList.add('data_hide');
    }
    else{
        try {
            let url = `https://api.openweathermap.org/data/2.5/weather?q=${cityVal}&units=metric&appid=a0f0ed818fd5eb2125f1504c77a652f2`;
